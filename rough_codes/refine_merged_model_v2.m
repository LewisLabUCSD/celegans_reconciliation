function [model1,model_unref,dup_rxns,rem_rxns,res_rxns,gra_rxns,prep_rem,account,ch,t] = refine_merged_model_v2(modelA,modelB,obj_rxn,remFlag)
...
[unatom1,uncharge1] = check_charge_formula_improvement(model1,res_rxns(:,1));
[unatom2,uncharge2] = check_charge_formula_improvement(model1,res_rxns(:,2));
